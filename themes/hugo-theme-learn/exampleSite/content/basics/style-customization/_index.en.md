...
If your favicon is a png, just drop off your image in your local `static/NguyenQuocCuongWorkshop/images/` folder and name it `favicon.png`
...
![Red variant](/en/basics/style-customization/NguyenQuocCuongWorkshop/images/red-variant.png?width=60pc)
...
![Blue variant](/en/basics/style-customization/NguyenQuocCuongWorkshop/images/blue-variant.png?width=60pc)
...
![Green variant](/en/basics/style-customization/NguyenQuocCuongWorkshop/images/green-variant.png?width=60pc)
